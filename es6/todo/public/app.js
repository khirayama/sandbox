  ...
  _createClass(TodoItem, [{
    ...
    value: function handleEvents() {
      ...
      this.on('blur', '.edit', function (event) {
        ...
        _TodoActions2['default'].updateText(_this.todo.id, text);
      });
    }
  }, {
    key: 'on',
